...
rm -f craft.o
rm -f external.o
riscv64-unknown-elf-clang -c -S -O0 -emit-llvm test.c
riscv64-unknown-elf-clang -c -S -O0 -emit-llvm debug.c
riscv64-unknown-elf-clang test.ll -o test_insecure -lm
...
riscv64-unknown-elf-clang testx.o craft.o debug.o external.o -o test_secure -lm
